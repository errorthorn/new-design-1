...
import { LearnedWordsList } from "@/components/speaking-club/learned-words-list";
import { AttendanceCard } from "@/components/speaking-club/attendance-card";
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F8FAFC" }}>
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        {/* Post-call takeaway — the words this student noted down during
            their calls (Feature #4). Shown whenever they're signed in,
            regardless of whether a shift is running right now. */}
        {authStage === "ready" && (
          <>
            <AttendanceCard />
            <LearnedWordsList />
